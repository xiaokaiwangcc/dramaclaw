"""Validate storyboard director label JSONL rows."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Validate storyboard director labels JSONL rows.")
    parser.add_argument("labels_jsonl", help="Path to storyboard_labels.jsonl")
