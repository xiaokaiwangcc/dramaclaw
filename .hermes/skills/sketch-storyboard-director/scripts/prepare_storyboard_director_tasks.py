"""Prepare teacher tasks for storyboard-director edits."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Prepare storyboard director tasks.")
    ...
    parser.add_argument(
        ...
        default="",
        help=(
            "Output JSONL path; defaults to verify_reports/epXXX/storyboard_tasks.jsonl "
            "under the project"
        ),
    )
    parser.add_argument("--limit", type=int, default=0, help="Optional max beat count")
