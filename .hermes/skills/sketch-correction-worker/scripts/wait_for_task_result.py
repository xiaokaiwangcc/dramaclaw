"""Wait for a task_state entry to reach completed/failed and print its result."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Wait for a task_state record to finish.")
