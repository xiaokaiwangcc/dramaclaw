...
- Validate covers the StoryDraft schema, static reachability, and automatic-branch fallback ordering. It does not compile Ink or mathematically prove that every condition combination is satisfiable.
