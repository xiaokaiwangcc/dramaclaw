...
# backend through either the current or legacy environment variable (and, for
# Codex, a valid CODEX_BIN).
if [ -z "${DRAMACLAW_CHAT_BACKEND:-}" ] && [ -z "${SUPERTALE_CHAT_BACKEND:-}" ]; then
